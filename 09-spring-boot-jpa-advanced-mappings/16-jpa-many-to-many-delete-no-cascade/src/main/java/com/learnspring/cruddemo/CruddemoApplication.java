...
import com.learnspring.cruddemo.entity.*;
...
//			deleteCourseById(appDAO);
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		System.out.println("List of courses after update: " + student.getCourses());
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		// Create the students.
		Student student1 = new Student("Alice", "Smith", "alice@gmail.com");
