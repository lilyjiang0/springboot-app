...
public class MyDemoLoggingAspect {
    // Advice for @Around on the getFortune method. Re-throw exception
    ...
    public Object aroundGetFortuneRethrowExc(
            ProceedingJoinPoint proceedingJoinPoint
    ) throws Throwable {
        // Print out method name.
        String methodName = proceedingJoinPoint.getSignature().toShortString();
        System.out.println("\n =========>> Executing @Around Rethrow on method: " + methodName);
        // Get begin timestamp.
    ...
    // Advice for @Around on the getFortune method. Handle exception.
    // Like a @Before + @After, but give you more control of the process.
    // Use cases e.g. logging, auditing, security, pre-processing and post-processing data.
//    @Around("execution(* com.learnspring.aopdemo.service.*.getFortune(..))")
