# Overview
This repository is a record of my Java Spring & Spring Boot learning journey and real-time mini projects. Udemy course by Chad Darby - Spring Boot 3: Learn Spring 6, Spring Core, Spring REST, Spring MVC, Spring Security, Thymeleaf, JPA, Hibernate, MySQL.
...
- Perform auto-scanning of Spring beans to minimise configuration
...
- Parameterise Spring Boot REST API endpoints using PathVariable
...
- Minimise boilerplate code with Spring Data JPA and the JpaRepository
...
- Leverage Spring Data REST to eliminate custom code for controllers and services
- Automatically expose REST endpoints for your JPA Repositories
- Customise REST-based path endpoints
...
- Add logout support using the default features of Spring Boot Security
...
- Create a Spring Security Real-Time Project using authorisation, authentication and database encryption

## Spring MVC
- Set up your Spring Boot MVC environment with configs and directories
- Create controllers using Controller annotation
- Read HTML form data using RequestParam
- Leverage Spring Boot MVC model to transport data between the controller and the view page
- Define Request Mappings for GET and POST requests
- Minimise coding with Spring Boot MVC Form data binding
...
- Create a Spring Boot project with Thymeleaf using the Spring Initialiser website
